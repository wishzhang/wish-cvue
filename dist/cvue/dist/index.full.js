...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CVue = {}));
})(this, (function (exports) { 'use strict';

    const INSTALLED_KEY = Symbol("INSTALLED_KEY");
    const createInstaller = (components, plugins) => {
      const install = (app) => {
    ...
    const formEmits = {
      change: (evt) => evt instanceof Event,
      submit: (form) => {
      }
    };
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.columns, (item, index) => {
              return openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  (openBlock(), createBlock(resolveDynamicComponent(_ctx.$cvue._getOptionType(item.type))))
                ]),
                _: 2
              }, 1032, ["label"]);
            }), 128))
    ...
    function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return openBlock(), createBlock(_component_el_radio_group, {
        modelValue: _ctx.theValue,
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.theValue = $event)
      }, {
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.dicData, (item, index) => {
            return openBlock(), createElementBlock(Fragment, { key: index }, [
              _ctx.button ? (openBlock(), createBlock(_component_el_radio_button, {
                key: 0,
                size: _ctx.size,
                label: item.value,
                ...
                _: 2
              }, 1032, ["size", "label", "disabled", "border"])) : (openBlock(), createBlock(_component_el_radio, {
                key: 1,
                size: _ctx.size,
                label: item.value,
                disabled: _ctx.disabled,
                ...
                _: 2
              }, 1032, ["size", "label", "disabled", "border"]))
            ], 64);
          }), 128))
        ]),
        _: 3
